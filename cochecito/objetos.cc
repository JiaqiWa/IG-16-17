...
_cochecito::_cochecito(_cubo &caj, _revolucion &cilindr, float al, float bet)
{
        caja=caj;
        cilindro=cilindr;
        alfa=alfa;
...
void _cochecito::rueda()
{
        glPushMatrix();
        glRotatef(alfa,0,0,1);
        glRotatef(90.0,1,0,0);
        cilindro.draw_solido(0,0,0.8);
        cilindro.draw_aristas(0,0,0.7,1);
        glPopMatrix();
}

void _cochecito::ruedaDelanteras()
{
        glPushMatrix();
        glTranslatef(7,1,0);
...
void _cochecito::cajas()
{
        glPushMatrix();
        glTranslatef(0,1,1);
        glScalef(4,1,2);
        caja.draw_aristas(1,0.5,0,1);
        caja.draw_solido(1.0,0.8,0);
        glPopMatrix();
...
void _cochecito::luzDelanteras()
{
        glPushMatrix();
        glTranslatef(8,2.5,4.5);
        luz();
